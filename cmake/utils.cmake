...
function(add_external_target TARGET)
    ...
    set(ENV_COMMAND ${CMAKE_COMMAND} -E env ${EXTERNAL_ENV_ARGS} --)

    if(EXTERNAL_CONFIGURE_COMMAND)
        set(EXTERNAL_CONFIGURE_COMMAND ${ENV_COMMAND} ${EXTERNAL_CONFIGURE_COMMAND})
    else()
        set(EXTERNAL_CONFIGURE_COMMAND ${CMAKE_COMMAND} -E true)
    endif()

    if(EXTERNAL_BUILD_COMMAND)
        set(EXTERNAL_BUILD_COMMAND ${ENV_COMMAND} ${EXTERNAL_BUILD_COMMAND})
    else()
        set(EXTERNAL_BUILD_COMMAND ${CMAKE_COMMAND} -E true)
    endif()

    if(EXTERNAL_INSTALL_COMMAND)
        set(EXTERNAL_INSTALL_COMMAND ${ENV_COMMAND} ${EXTERNAL_INSTALL_COMMAND})
    else()
        set(EXTERNAL_INSTALL_COMMAND ${CMAKE_COMMAND} -E true)
    endif()

    if(EXTERNAL_UPDATE_COMMAND)
        set(EXTERNAL_UPDATE_COMMAND ${ENV_COMMAND} ${EXTERNAL_UPDATE_COMMAND})
    endif()

    if(EXTERNAL_PATCH_COMMAND)
        set(EXTERNAL_PATCH_COMMAND ${ENV_COMMAND} ${EXTERNAL_PATCH_COMMAND})
    endif()
    ...
    ExternalProject_Add(${TARGET}
        ...
        PATCH_COMMAND ${EXTERNAL_PATCH_COMMAND}
